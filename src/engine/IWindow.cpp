...
std::wstring IWindow::GetAssetFullPath(LPCWSTR assetName) const
{
    return myAssetsPath + assetName;
}

std::wstring IWindow::GetEngineShaderFullPath(LPCWSTR assetName) const
{
    return myEngineShaderPath + assetName;
}

// Helper function for acquiring the first available hardware adapter that supports Direct3D 12.
// If no such adapter can be found, *ppAdapter will be set to nullptr.
_Use_decl_annotations_
void IWindow::GetHardwareAdapter(
